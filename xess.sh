...
start() {
    ...
    default_subdomain=""
    read -p $'\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Choose a subdomain? [y/N]: \e[0m' choose_sub
    choose_sub="${choose_sub:-${default_choose_sub}}"
    if [[ $choose_sub == "y" || $choose_sub == "Y" ]]; then
        read -p $'\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Enter subdomain: \e[0m' subdomain
        subdomain_resp=true
        subdomain="$subdomain"
    else
